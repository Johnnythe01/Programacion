...
public class CidefyApp {
    ...
    public static void main(String[] args) {
        ...
        Artista top1 = coleccion.artistaMasEscuchado(null);
        Artista.pintarInformacion();
        ...
        coleccion.añadirArtista(new Artista("Deluxe", EstiloMusical.POP, "Tum Rakak", "Francia"));
    ...
    private static ColeccionArtistas creaColeccionArtistas(){
        Artista halsey = new Artista("Halsey", EstiloMusical.POP, "Closer", "America");
        Artista edSheeran = new Artista("EdSheeran", EstiloMusical.POP, "Perfect", "Reino Unido");
        Artista izal = new Artista("Izal", EstiloMusical.POP, "La mujer de verde", "España");
        Artista nilMoliner = new Artista("Nil Moliner", EstiloMusical.POP, "Esperando", "España");
        Artista supersubmarina = new Artista("Supersubmarina", EstiloMusical.POP, "Supersubmarina", "España");
        Artista articMonkeys = new Artista("Artic Monkeys", EstiloMusical.POP, "R U Mine?", "Reino Unido");
